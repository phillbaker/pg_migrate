...
\! pg_migrate --dbname=contrib_regression --table=issue3_1 --alter='ADD COLUMN c1 INT' --execute
...
\! pg_migrate --dbname=contrib_regression --table=issue3_2 --alter='ADD COLUMN c1 INT' --execute
...
\! pg_migrate --dbname=contrib_regression --table=issue3_3 --alter='ADD COLUMN c1 INT' --execute
...
\! pg_migrate --dbname=contrib_regression --table=issue3_4 --alter='ADD COLUMN c1 INT' --execute
...
\! pg_migrate --dbname=contrib_regression --table=issue3_5 --alter='ADD COLUMN c1 INT' --execute
